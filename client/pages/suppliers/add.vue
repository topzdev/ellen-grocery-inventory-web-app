<template>
  <v-form ref="addForm" :lazy-validation="true">
    <v-toolbar :color="''" :flat="true">
      <v-toolbar-title class="display-1 font-weight-bold">Add Supplier</v-toolbar-title>
    </v-toolbar>
    <v-row class="px-4">
      <v-col cols="8">
        <v-row>
        ...
        <v-row>
          <v-col class="d-flex">
            ...
            <v-btn :disabled="!valid" color="success" class="mr-4 d-flex ml-auto" large>Add Supplier</v-btn>
          </v-col>
        </v-row>
      </v-col>
    </v-row>
